        ...
        <div class="modal-body">
            <form action="api/post/createData.php" method="post" id="addPatientForm" autocomplete="off">
                ...
                <div class="input">
                    ...
                    <input type="text" name="informant" class="informant_name width-100" required>
                </div>
                
                <div class="input">
                    <label for="" class="rel_informant">Relation to informant:</label>
                    <input type="text" name="informant_relation" class="rel_informant width-100" required>
                </div>
                ...
                <div class="calendar margin-t-20">
